...
- Use bookmarks to save, find, organize, or open saved pages. Delete or move bookmarks only when the user clearly asked.
- Use history to find or reopen pages from the current browser profile. Delete history only when the user clearly asked.
...
- bookmarks and history use BrowserOS CDP on BrowserOS, or the Chrome extension bridge with bookmarks/history permissions on standard Chrome.
